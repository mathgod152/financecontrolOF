    ...
    <section class="registro">
        ...
        <div class="selecionar">
            ...
            <?php foreach ($info0 as $key => $value){?>
                <option value=<?php echo $value['id']?>>Entradas: <?php echo $value['nome_entradaF'] ;?>Id: <?php echo $value['id'] ;?></option>
                <?php } ?>
            <?php foreach ($info1 as $key => $value1){?>
                <option value=<?php echo $value1['id']?>>Divida: <?php echo $value1['nome_dividaF'];?>Id: <?php echo $value1['id'] ;?></option>
                <?php } ?>
